...
export default function EditUserPage() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      if (res.ok) {
        ...
        setIsEnrollmentAdmin(userData.isEnrollmentAdmin || false);
        setIsProfesor(userData.isProfesor || false);
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-6 text-gray-900">Editar Usuario</h1>
